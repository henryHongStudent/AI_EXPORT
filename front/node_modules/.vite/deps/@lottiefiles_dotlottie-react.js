...
function DotLottieComponent(_a) {
  ...
  return (0, import_jsx_runtime.jsx)("div", __spreadProps(__spreadValues({ ref: setContainerRef, className }, !className && { style: containerStyle }), { children: (0, import_jsx_runtime.jsx)(
    "canvas",
...
var useDotLottie = (config) => {
  ...
  const Component = (0, import_react.useCallback)(
    (props) => {
      return (0, import_jsx_runtime.jsx)(DotLottieComponent, __spreadValues({ setContainerRef, setCanvasRef }, props));
    },
...
var DotLottieReact = (_a) => {
  ...
  return (0, import_jsx_runtime.jsx)(DotLottieComponent2, __spreadValues({}, props));
};
...
var useDotLottieWorker = (config) => {
  ...
  const Component = (0, import_react.useCallback)(
    (props) => {
      return (0, import_jsx_runtime.jsx)(DotLottieWorkerComponent, __spreadValues({ setContainerRef, setCanvasRef }, props));
    },
    [setCanvasRef, setContainerRef]
  );
  (0, import_react.useEffect)(() => {
