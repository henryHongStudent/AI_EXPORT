...
var _AnnotationEditorUIManager = class _AnnotationEditorUIManager {
  ...
  onScaleChanging({
    ...
    (_a2 = this.currentLayer) == null ? void 0 : _a2.onScaleChanging();
  }
  onRotationChanging({
    pagesRotation
  }) {
  ...
  setSelected(editor) {
    var _a2;
    (_a2 = this.currentLayer) == null ? void 0 : _a2.commitOrRemove();
  ...
  unselectAll() {
    ...
    if ((_a2 = this.currentLayer) == null ? void 0 : _a2.commitOrRemove()) {
      return;
    }
    if (!this.hasSelection) {
      return;
...
var _accessibilityData, _allResizerDivs, _altText3, _disabled, _dragPointerId, _dragPointerType, _keepAspectRatio, _resizersDiv, _lastPointerCoords, _savedDimensions, _focusAC, _focusedResizerName, _hasBeenClicked, _initialPosition, _isEditing, _isInEditMode, _isResizerEnabledForKeyboard, _moveInDOMTimeout, _prevDragX, _prevDragY, _telemetryTimeouts, _isDraggable, _zIndex, _AnnotationEditor_instances, translate_fn, _AnnotationEditor_static, rotatePoint_fn, getRotationMatrix_fn, createResizers_fn, resizerPointerdown_fn, resize_fn, addResizeToUndoStack_fn, resizerPointermove_fn, selectOnPointerEvent_fn, setUpDragSession_fn, addFocusListeners_fn, resizerKeydown_fn, resizerBlur_fn, resizerFocus_fn, setResizerTabIndex_fn, stopResizing_fn;
...
setUpDragSession_fn = function(event) {
  ...
  if (isSelected) {
    ...
    window.addEventListener("pointerdown", (e) => {
      if (e.isPrimary && e.pointerType === __privateGet(this, _dragPointerType)) {
        cancelDrag(e);
      }
      stopEvent(e);
    }, opts);
...
var NodeCanvasFactory = class extends BaseCanvasFactory {
  _createCanvas(width, height) {
    const require2 = process.getBuiltinModule("module").createRequire("file:///home/runner/work/pdf.js/pdf.js/src/display/node_utils.js");
...
var _drawOutlines, _mustBeCommitted, _DrawingEditor_instances, createDrawOutlines_fn, createDrawing_fn, cleanDrawLayer_fn2, addToDrawLayer_fn2, convertToParentSpace_fn, convertToDrawSpace_fn, updateBbox_fn, rotateBox_fn;
var _DrawingEditor = class _DrawingEditor extends AnnotationEditor {
  ...
  static startDrawing(parent, uiManager, _isLTR3, {
    target,
    offsetX: x,
    offsetY: y
  }) {
...
__publicField(_DrawingEditor, "_currentDraw", null);
__publicField(_DrawingEditor, "_currentDrawingOptions", null);
...
var InkDrawOutliner = class {
  ...
  add(x, y) {
    ...
    __privateGet(this, _line2).push((x1 + 5 * x2) / 6, (y1 + 5 * y2) / 6, (5 * x2 + x) / 6, (5 * y2 + y) / 6, (x2 + x) / 2, (y2 + y) / 2);
    return {
      path: {
        d: this.toSVGPath()
      }
...
var _bitmap, _bitmapId, _bitmapPromise, _bitmapUrl, _bitmapFile, _bitmapFileName, _canvas, _observer, _resizeTimeoutId, _isSvg, _hasBeenAddedInUndoStack, _StampEditor_instances, getBitmapFetched_fn, getBitmapDone_fn, getBitmap_fn, createCanvas_fn, setDimensions_fn, scaleBitmap_fn, drawBitmap_fn, serializeBitmap_fn, createObserver_fn, hasElementChanged_fn3;
...
var _accessibilityManager2, _allowClick, _annotationLayer, _clickAC, _editorFocusTimeoutId, _editors, _hadPointerDown, _isDisabling, _drawingAC, _textLayer, _textSelectionAC, _uiManager3, _editorTypes2, _AnnotationEditorLayer_instances, textLayerPointerDown_fn, currentEditorType_get, createNewEditor_fn, getCenterPoint_fn, cleanup_fn;
var _AnnotationEditorLayer = class _AnnotationEditorLayer {
  ...
  startDrawingSession(event) {
    ...
    __privateGet(this, _uiManager3).disableUserSelect(true);
    __privateGet(this, _AnnotationEditorLayer_instances, currentEditorType_get).startDrawing(this, __privateGet(this, _uiManager3), false, event);
  }
  endDrawingSession(isAborted = false) {
    ...
    __privateGet(this, _uiManager3).disableUserSelect(false);
